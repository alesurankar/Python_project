...
def create_view_menu(root, menubar):
    ...
    appearance_menu.add_checkbutton(label="Menu Bar", variable=root.appearance_menu_bar, command=cmd("menu_bar"))
    appearance_menu.add_checkbutton(label="Primary Side Bar", variable=root.appearance_primary_side, command=cmd("primary_side_bar"))
    appearance_menu.add_checkbutton(label="Secondary Side Bar", variable=root.appearance_secondary_side, command=cmd("secondary_side_bar"))
    appearance_menu.add_checkbutton(label="Status Bar", variable=root.appearance_status_bar, command=cmd("status_bar"))
    appearance_menu.add_checkbutton(label="Panel", variable=root.appearance_panel, command=cmd("panel"))
    appearance_menu.add_separator()
    ...
    activity_bar_position_menu.add_radiobutton(label="Default", variable=root.activity_bar_position, value="Default", command=cmd("activity_bar_position_default"))
    activity_bar_position_menu.add_radiobutton(label="Top", variable=root.activity_bar_position, value="Top", command=cmd("activity_bar_position_top"))
    activity_bar_position_menu.add_radiobutton(label="Bottom", variable=root.activity_bar_position, value="Bottom", command=cmd("activity_bar_position_bottom"))
    activity_bar_position_menu.add_radiobutton(label="Hidden", variable=root.activity_bar_position, value="Hidden", command=cmd("activity_bar_position_hidden"))
    ...
    panel_position_menu.add_radiobutton(label="Top", variable=root.panel_position, value="Top", command=cmd("panel_position_top"))
    panel_position_menu.add_radiobutton(label="Left", variable=root.panel_position, value="Left", command=cmd("panel_position_left"))
    panel_position_menu.add_radiobutton(label="Right", variable=root.panel_position, value="Right", command=cmd("panel_position_right"))
    panel_position_menu.add_radiobutton(label="Bottom", variable=root.panel_position, value="Bottom", command=cmd("panel_position_bottom"))
    ...
    align_panel_menu.add_radiobutton(label="Center", variable=root.align_panel, value="Center", command=cmd("align_panel_center"))
    align_panel_menu.add_radiobutton(label="Justify", variable=root.align_panel, value="Justify", command=cmd("align_panel_justify"))
    align_panel_menu.add_radiobutton(label="Left", variable=root.align_panel, value="Left", command=cmd("align_panel_left"))
    align_panel_menu.add_radiobutton(label="Right", variable=root.align_panel, value="Right", command=cmd("align_panel_right"))
    ...
    tab_bar_menu.add_radiobutton(label="Multiple Tabs", variable=root.tab_bar, value="Multiple Tabs", command=cmd("tab_bar_multiple_tabs"))
    tab_bar_menu.add_radiobutton(label="Single Tab", variable=root.tab_bar, value="Single Tab", command=cmd("tab_bar_single_tab"))
    tab_bar_menu.add_radiobutton(label="Hidden", variable=root.tab_bar, value="Hidden", command=cmd("tab_bar_hidden"))
    ...
    editor_actions_position_menu.add_radiobutton(label="Tab Bar", variable=root.editor_actions_position, value="Tab Bar", command=cmd("editor_actions_position_tab_bar"))
    editor_actions_position_menu.add_radiobutton(label="Title Bar", variable=root.editor_actions_position, value="Title Bar", command=cmd("editor_actions_position_title_bar"))
    editor_actions_position_menu.add_radiobutton(label="Hidden", variable=root.editor_actions_position, value="Hidden", command=cmd("editor_actions_position_hidden"))
    ...
    appearance_menu.add_checkbutton(label="Minimap", variable=root.appearance_minimap, command=cmd("minimap"))
    appearance_menu.add_checkbutton(label="Breadcrumbs", variable=root.appearance_breadcrumbs, command=cmd("breadcrumbs"))
    appearance_menu.add_checkbutton(label="Sticky Scroll", variable=root.appearance_sticky_scroll, command=cmd("sticky_scroll"))
    appearance_menu.add_checkbutton(label="Render Whitespace", variable=root.appearance_render_whitespace, command=cmd("render_whitespace"))
    appearance_menu.add_checkbutton(label="Render Control Characters", variable=root.appearance_render_control_characters, command=cmd("render_control_characters"))
    appearance_menu.add_separator()
